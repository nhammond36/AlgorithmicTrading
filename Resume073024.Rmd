...
Experienced economist and quantitative researcher-  fixed income, risk management, monetary policy, with over 15 years of industry experience. Yield curve and fixed income models, financial mathematics, risk management,  deep learning,  machine learning-AI, monetary policy and repurchase markets. C++, Matlab, Python, R, Stata. 
...
- Monetary policy 
- Repurchase markets 
- Risk mitigation model development & validation 
- Credit, operational risk, counterparty credit risk, settlement risk, liquidity risk, market risk 
- Python, R, Matlab, C++, Stata, Python, GitHub, LaTeX.
- Effective communication with multiple stakeholders, well-organized, 
- Lifelong learner.
